...
//  جديد: مراحل الشغل الجاري — بتتحدث من صفحة pro-jobs عن طريق
...
export interface Booking {
  ...
  workerName: string;
  clientName: string;
  //  workerTrade ده النص العربي المعروض (زي "كهربا")، مش الـ slug.
  ...
  //  totalAmount بقى يمثل السعر النهائي بعد الخصم (لو فيه كوبون اتطبق).
  ...
  //  جديد — null لحد ما الطلب يتقبل ويبقى active، وقتها بيبدأ من
